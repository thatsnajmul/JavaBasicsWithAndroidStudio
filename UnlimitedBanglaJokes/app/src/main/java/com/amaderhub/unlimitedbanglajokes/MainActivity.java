package com.amaderhub.unlimitedbanglajokes;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gopalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                myintent=new Intent(MainActivity.this,GopalvarStory.class);
        ...
        student_teacher.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myintent=new Intent(MainActivity.this,StudentTeacherStory.class);
                startActivity(myintent);
            }
        });
        ...
        doctor_patient.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myintent=new Intent(MainActivity.this,DoctorPatientStory.class);
                startActivity(myintent);
            }
        });
        ...
        love_lover.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myintent=new Intent(MainActivity.this,Love_Lover_Story.class);
                startActivity(myintent);
            }
        });
        ...
        Boltu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myintent=new Intent(MainActivity.this,Boltu_Story.class);
                startActivity(myintent);
            }
        });
        ...
        husband_wife.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myintent=new Intent(MainActivity.this,HusbandWifeStory.class);
                startActivity(myintent);
            }
        });
        ...
        nasiruddin_hoja.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myintent=new Intent(MainActivity.this,NasiruddinHojaStory.class);
                startActivity(myintent);
            }
        });
        ...
        mod_matal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myintent=new Intent(MainActivity.this,ModMatalStory.class);
                startActivity(myintent);
            }
        });
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myintent=new Intent(MainActivity.this,UnlimitedStoryPage1.class);
                startActivity(myintent);
            }
        });
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myintent=new Intent(MainActivity.this,UnlimitedStoryPage2.class);
                startActivity(myintent);
            }
        });
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myintent=new Intent(MainActivity.this,UnlimitedStoryPage4.class);
                startActivity(myintent);
            }
        });
        ...
        button5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myintent=new Intent(MainActivity.this,UnlimitedStoryPage5.class);
                startActivity(myintent);
            }
        });
        ...
        button7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myintent=new Intent(MainActivity.this,UnlimitedStoryPage7.class);
                startActivity(myintent);
            }
        });
        ...
        button8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myintent=new Intent(MainActivity.this,UnlimitedStoryPage8.class);
                startActivity(myintent);
            }
        });
        ...
        button10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myintent=new Intent(MainActivity.this,UnlimitedStoryPage10.class);
                startActivity(myintent);
            }
        });
        ...
        button13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myintent=new Intent(MainActivity.this,UnlimitedStoryPage13.class);
                startActivity(myintent);
            }
        });
        ...
        button15.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myintent=new Intent(MainActivity.this,UnlimitedStoryPage15.class);
                startActivity(myintent);
            }
        });
        ...
        button16.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myintent=new Intent(MainActivity.this,UnlimitedStoryPage16.class);
                startActivity(myintent);
            }
        });
        ...
        button17.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myintent=new Intent(MainActivity.this,UnlimitedStoryPage17.class);
                startActivity(myintent);
            }
        });
        ...
        button19.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myintent=new Intent(MainActivity.this,UnlimitedStoryPage19.class);
                startActivity(myintent);
            }
        });
